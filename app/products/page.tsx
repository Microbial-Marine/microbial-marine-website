        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {products.map((product) => (
              <div key={product.id} className={`bg-ocean border ${product.border} rounded-3xl p-8 flex flex-col transition-colors`}>
                <div className={`relative h-64 rounded-2xl overflow-hidden bg-gradient-to-br ${product.accent} mb-8`}>
